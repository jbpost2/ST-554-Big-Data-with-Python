...
| 4/7-4/11          | 02 - Basic Summaries on Streaming Data\                         |                                           |
|                   | 03 - Preprocessing, Sending Alerts, & Combining Streams         | (emphasis on 5-13)                        |
+-------------------+-----------------------------------------------------------------+-------------------------------------------+
| Week 15\          | 04 - Spark Structured Streaming\                                | Final Project due M, 4/28                 |
| 4/14-4/18         | 05 - Reading & Writing Streams with Spark Structured Streaming\ |                                           |
|                   | 06 - Transformations, Windowing, & Aggregations\                |                                           |
|                   | 07 - Streaming Joins                                            |                                           |
+-------------------+-----------------------------------------------------------------+-------------------------------------------+
