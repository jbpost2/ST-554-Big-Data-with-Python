...
- Now computation is done immediately and results returned
...
- Performing Actions on a Column
    ...
    - `.withColumn()` method is useful to create a new column from another
    - [Lots of SQL functions](https://spark.apache.org/docs/3.3.1/api/python/reference/pyspark.sql/functions.html) available
```{python, eval = FALSE}
