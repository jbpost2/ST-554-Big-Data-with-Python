...
```{r, echo = FALSE, fig.align = 'center', out.width = "450px", fig.alt = "A line plot is shown with alpha (shrinkage parameter) on the x-axis and the standardized value of coefficients on the y-axis. A the shrinkage increases, all lines tend toward 0, indicating slope estimates are set to 0."}
...
```{python, echo = FALSE, eval = TRUE, include = FALSE, message = FALSE, fig.alt = "A line plot is shown with alpha (shrinkage parameter) on the x-axis and the standardized value of coefficients on the y-axis. The coefficents start at -0.22 and 0.08. They are shrunk as alpha grows with the -0.22 coefficient being set to 0 first. The other estimate is set to 0 after more shrinkage."}
...
```{r, echo = FALSE, fig.align = 'center', out.width = "600px", fig.alt = "A rectangle representing the data is shown. The first part of the rectangle is split into a training and validation portion with the last portion being set to the test data."}
