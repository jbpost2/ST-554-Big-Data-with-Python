...
```{r, echo = FALSE, out.width="600px", fig.alt = "A rectangle representing the dataset is shown. Most of the rectangle is blue, indicating it is part of the training data. The rest of the rectangle is green, indicating it is a part of the test, or holdout, set."}
