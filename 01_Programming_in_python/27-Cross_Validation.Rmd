...
```{r, echo = FALSE, out.width="600px", fig.alt = "A visual describing four cross-validation is shown. In iteration one, the first 1/4 of the data is shown as the test data and remaining 3/4 of the data is shown as the training data. In the second iteration, the first 1/4 and the last 1/2 is shown as the training data and the second 1/4 as the test data. This is repeated until all sections are used as the test set."}
